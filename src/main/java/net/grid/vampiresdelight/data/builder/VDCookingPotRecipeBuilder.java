...
public class VDCookingPotRecipeBuilder {
    ...
    private VDCookingPotRecipeBuilder(ItemLike resultIn, int count, int cookingTime, float experience, @Nullable ItemLike container) {
    ...
    public VDCookingPotRecipeBuilder addIngredient(TagKey<Item> tagIn) {
        return addIngredient(Ingredient.of(tagIn));
    }

    public VDCookingPotRecipeBuilder addIngredient(ItemLike itemIn) {
        return addIngredient(itemIn, 1);
    }

    public VDCookingPotRecipeBuilder addIngredient(ItemLike itemIn, int quantity) {
    ...
    public VDCookingPotRecipeBuilder addIngredient(Ingredient ingredientIn) {
        return addIngredient(ingredientIn, 1);
    }

    public VDCookingPotRecipeBuilder addIngredient(Ingredient ingredientIn, int quantity) {
        for (int i = 0; i < quantity; ++i) {
    ...
    public VDCookingPotRecipeBuilder unlockedBy(String criterionName, CriterionTriggerInstance criterionTrigger) {
        advancement.addCriterion(criterionName, criterionTrigger);
        return this;
    }

    public VDCookingPotRecipeBuilder unlockedByItems(String criterionName, ItemLike... items) {
        return unlockedBy(criterionName, InventoryChangeTrigger.TriggerInstance.hasItems(items));
    }

    public VDCookingPotRecipeBuilder unlockedByAnyIngredient(ItemLike... items) {
    ...
    public VDCookingPotRecipeBuilder setRecipeBookTab(CookingPotRecipeBookTab tab) {
        this.tab = tab;
        return this;
    }
    ...
    public void build(Consumer<FinishedRecipe> consumerIn) {
        ...
        build(consumerIn, VampiresDelight.MODID + ":cooking/" + location.getPath());
    }
