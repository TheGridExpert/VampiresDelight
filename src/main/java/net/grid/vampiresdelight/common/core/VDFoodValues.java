...
public class VDFoodValues {
    ...
    // Drinks
    public static final FoodProperties DANDELION_BEER_MUG = new FoodProperties.Builder().alwaysEat()
    ...
    public static final FoodProperties RAW_BAT = new FoodProperties.Builder()
            .nutrition(2).saturationMod(0.3f)
            .effect(batMeatWitherEffect(FLEETING_DURATION), 0.4F).meat().build();

    public static final FoodProperties RAW_BAT_CHOPS = new FoodProperties.Builder()
            .nutrition(1).saturationMod(0.3f).fast()
            .effect(batMeatWitherEffect(FLEETING_DURATION), 0.2F).meat().build();
    ...
    public static final FoodProperties ORCHID_ICE_CREAM = new FoodProperties.Builder()
            ...
            .effect(() -> new MobEffectInstance(ModEffects.FIRE_PROTECTION.get(), SHORT_DURATION, 1), 1.0F).build();
    ...
    public static final FoodProperties PURE_SORBET = new FoodProperties.Builder()
            ...
            .effect(() -> new MobEffectInstance(VDEffects.FOG_VISION.get(), 2400), 1.0F).build();
    ...
    public static final FoodProperties SNOW_WHITE_ICE_CREAM = new FoodProperties.Builder()
            ...
            .effect(() -> new MobEffectInstance(VDEffects.CONSECRATION.get(), MEDIUM_DURATION), 1.0F).build();
    ...
    public static final FoodProperties WEIRD_JELLY = new FoodProperties.Builder()
            ...
            .effect(() -> {
                if (VDCommonConfig.REPLACE_WEIRD_JELLY_SUNSCREEN_WITH_JUMP_BOOST.get()) {
    ...
    public static Supplier<MobEffectInstance> batMeatWitherEffect(int duration) {
        return () -> new MobEffectInstance(VDCommonConfig.BAT_MEAT_WITHERS_HUMANS.get() ? MobEffects.WITHER : MobEffects.POISON, duration);
    }
}
