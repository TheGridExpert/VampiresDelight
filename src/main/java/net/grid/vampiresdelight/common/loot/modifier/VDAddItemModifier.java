...
/**
 * VDAddItemModifier is Farmer's Delight's AddItemModifier adapted for Vampire's Delight
 */
public class VDAddItemModifier extends LootModifier {
    public static final Supplier<Codec<VDAddItemModifier>> CODEC = Suppliers.memoize(() ->
     ...
     */
    protected VDAddItemModifier(LootItemCondition[] conditionsIn, Item addedItemIn, int count) {
        super(conditionsIn);
