...
public class BloodBottleShapelessRecipes extends ShapelessRecipe {
    final NonNullList<Ingredient> ingredients;
    private final boolean isSimple;

    public BloodBottleShapelessRecipes(ResourceLocation resourceLocation, String group, ItemStack output, NonNullList<Ingredient> inputs) {
